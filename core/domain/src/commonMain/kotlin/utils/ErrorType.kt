...
class UnknownErrorException(message: String) : AppException(message)

class NotFoundException(message: String) : AppException(message)

class SocketClosedException(message: String) : AppException(message)

open class AuthorizationException(val errorMessage: String = "") : AppException(errorMessage) {
